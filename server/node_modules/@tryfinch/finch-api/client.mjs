...
var _Finch_instances, _a, _Finch_encoder, _Finch_baseURLOverridden;
...
import { RequestForwarding, } from "./resources/request-forwarding.mjs";
import { Webhooks, } from "./resources/webhooks.mjs";
import { Connect } from "./resources/connect/connect.mjs";
import { HRIS } from "./resources/hris/hris.mjs";
...
export class Finch {
     ...
     */
    constructor({ baseURL = readEnv('FINCH_BASE_URL'), accessToken = null, clientID = readEnv('FINCH_CLIENT_ID') ?? null, clientSecret = readEnv('FINCH_CLIENT_SECRET') ?? null, webhookSecret = readEnv('FINCH_WEBHOOK_SECRET') ?? null, ...opts } = {}) {
        _Finch_instances.add(this);
        _Finch_encoder.set(this, void 0);
        ...
        this.payroll = new API.Payroll(this);
        this.connect = new API.Connect(this);
        const options = {
            accessToken,
            clientID,
            clientSecret,
        ...
        __classPrivateFieldSet(this, _Finch_encoder, Opts.FallbackEncoder, "f");
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!__classPrivateFieldGet(this, _Finch_instances, "m", _Finch_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return __classPrivateFieldGet(this, _Finch_encoder, "f").call(this, { body, headers });
        }
    }
    /**
    ...
    withAccessToken(accessToken) {
        return new _a({ ...this._options, accessToken });
    }
}
_a = Finch, _Finch_encoder = new WeakMap(), _Finch_instances = new WeakSet(), _Finch_baseURLOverridden = function _Finch_baseURLOverridden() {
    return this.baseURL !== 'https://api.tryfinch.com';
};
Finch.Finch = _a;
Finch.DEFAULT_TIMEOUT = 60000; // 1 minute
