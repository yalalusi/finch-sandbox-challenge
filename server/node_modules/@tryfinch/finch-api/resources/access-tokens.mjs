...
export class AccessTokens extends APIResource {
    ...
    create(body, options) {
        ...
        if (!clientID)
            throw new Error('client_id must be provided as an argument or with the FINCH_CLIENT_ID environment variable');
        const clientSecret = body.client_secret || this._client.clientSecret;
        if (!clientSecret)
            throw new Error('client_secret must be provided as an argument or with the FINCH_CLIENT_SECRET environment variable');
