...
class Webhooks extends resource_1.APIResource {
    ...
    parseSecret(secret) {
        ...
        try {
            const buf = (0, utils_1.fromBase64)(secret);
            if ((0, utils_1.toBase64)(buf) !== secret) {
    ...
    signPayload(payload, { eventId, timestamp, secret }) {
        ...
        const signed = (0, utils_1.toBase64)((0, hmac_1.hmac)(sha2_1.sha256, secret, toSign));
        return `v1,${signed}`;
    }
    ...
    verifySignature(body, headers, secret = this._client.webhookSecret) {
        ...
        const eventId = (0, headers_1.getRequiredHeader)(headers, 'finch-event-id');
        const msgTimestamp = (0, headers_1.getRequiredHeader)(headers, 'finch-timestamp');
        const msgSignature = (0, headers_1.getRequiredHeader)(headers, 'finch-signature');
