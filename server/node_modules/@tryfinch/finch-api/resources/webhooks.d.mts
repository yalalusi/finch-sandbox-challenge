...
import * as BenefitsAPI from "./hris/benefits/benefits.mjs";
...
export declare class Webhooks extends APIResource {
     ...
     */
    unwrap(payload: string, headers: HeadersLike, secret?: string | undefined | null): WebhookEvent;
    private parseSecret;
    private signPayload;
...
export declare namespace AccountUpdateEvent {
    interface Data {
    ...
    namespace Data {
        ...
        namespace AuthenticationMethod {
            /**
             * The supported data fields returned by our HR and payroll endpoints
             */
...
export declare namespace DirectoryEvent {
    interface Data {
        /**
...
export declare namespace EmploymentEvent {
    interface Data {
        /**
         * The ID of the individual related to the event.
         */
...
export declare namespace IndividualEvent {
    interface Data {
        /**
         * The ID of the individual related to the event.
         */
...
export interface JobCompletionEvent extends BaseWebhookEvent {
    ...
    event_type?: 'job.benefit_create.completed' | 'job.benefit_enroll.completed' | 'job.benefit_register.completed' | 'job.benefit_unenroll.completed' | 'job.benefit_update.completed' | 'job.data_sync_all.completed';
}
export declare namespace JobCompletionEvent {
    interface Data {
        /**
...
export declare namespace PayStatementEvent {
    interface Data {
        /**
...
export declare namespace PaymentEvent {
    interface Data {
        /**
