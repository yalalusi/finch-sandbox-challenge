...
exports.Page = exports.IndividualsPage = exports.ResponsesPage = exports.SinglePage = exports.PagePromise = exports.AbstractPage = void 0;
...
class ResponsesPage extends AbstractPage {
    constructor(client, response, body, options) {
        super(client, response, body, options);
...
exports.ResponsesPage = ResponsesPage;
class IndividualsPage extends AbstractPage {
    constructor(client, response, body, options) {
        super(client, response, body, options);
