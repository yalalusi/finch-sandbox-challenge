...
import { type IndividualsPageParams, IndividualsPageResponse, type PageParams, PageResponse, ResponsesPageResponse, SinglePageResponse } from "./core/pagination.mjs";
import * as Uploads from "./core/uploads.mjs";
import * as API from "./resources/index.mjs";
import { APIPromise } from "./core/api-promise.mjs";
import { AccessTokenCreateParams, AccessTokens, CreateAccessTokenResponse } from "./resources/access-tokens.mjs";
import { Account, DisconnectResponse, Introspection } from "./resources/account.mjs";
import { Provider, ProviderListResponse, ProviderListResponsesSinglePage, Providers } from "./resources/providers.mjs";
import { RequestForwarding, RequestForwardingForwardParams, RequestForwardingForwardResponse } from "./resources/request-forwarding.mjs";
import { AccountUpdateEvent, BaseWebhookEvent, CompanyEvent, DirectoryEvent, EmploymentEvent, IndividualEvent, JobCompletionEvent, PayStatementEvent, PaymentEvent, WebhookEvent, Webhooks } from "./resources/webhooks.mjs";
import { Connect } from "./resources/connect/connect.mjs";
import { HRIS, Income, Location, Money } from "./resources/hris/hris.mjs";
import { Jobs } from "./resources/jobs/jobs.mjs";
import { Payroll } from "./resources/payroll/payroll.mjs";
import { Sandbox } from "./resources/sandbox/sandbox.mjs";
...
export declare class Finch {
     ...
     */
    constructor({ baseURL, accessToken, clientID, clientSecret, webhookSecret, ...opts }?: ClientOptions);
    /**
    ...
    protected basicAuth(opts: FinalRequestOptions): Promise<NullableHeaders | undefined>;
...
export declare namespace Finch {
    ...
    export { type IndividualsPageParams as IndividualsPageParams, type IndividualsPageResponse as IndividualsPageResponse, };
    export import Page = Pagination.Page;
    export { type PageParams as PageParams, type PageResponse as PageResponse };
    export { AccessTokens as AccessTokens, type CreateAccessTokenResponse as CreateAccessTokenResponse, type AccessTokenCreateParams as AccessTokenCreateParams, };
    export { HRIS as HRIS, type Income as Income, type Location as Location, type Money as Money };
    export { Providers as Providers, type Provider as Provider, type ProviderListResponse as ProviderListResponse, type ProviderListResponsesSinglePage as ProviderListResponsesSinglePage, };
    export { Account as Account, type DisconnectResponse as DisconnectResponse, type Introspection as Introspection, };
    export { Webhooks as Webhooks, type AccountUpdateEvent as AccountUpdateEvent, type BaseWebhookEvent as BaseWebhookEvent, type CompanyEvent as CompanyEvent, type DirectoryEvent as DirectoryEvent, type EmploymentEvent as EmploymentEvent, type IndividualEvent as IndividualEvent, type JobCompletionEvent as JobCompletionEvent, type PayStatementEvent as PayStatementEvent, type PaymentEvent as PaymentEvent, type WebhookEvent as WebhookEvent, };
    export { RequestForwarding as RequestForwarding, type RequestForwardingForwardResponse as RequestForwardingForwardResponse, type RequestForwardingForwardParams as RequestForwardingForwardParams, };
    export { Jobs as Jobs };
